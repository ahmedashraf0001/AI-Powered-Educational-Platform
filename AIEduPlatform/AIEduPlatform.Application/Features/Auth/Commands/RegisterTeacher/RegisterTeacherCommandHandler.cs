...
{
    public class RegisterTeacherCommandHandler : IRequestHandler<RegisterTeacherCommand, Unit>
    {
        ...
        public async Task<Unit> Handle(RegisterTeacherCommand request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation("Teacher registered: {Email}. Sending verification email.", request.Email);
            ...
            var body = $@"
                ...
                <head>
                    <style>
                        ...
                        .btn {{ display: inline-block; padding: 12px 24px; background-color: #2196F3; color: white; text-decoration: none; border-radius: 4px; }}
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            ...
                            <p>Thank you for registering with AI Edu Platform as a teacher!</p>
