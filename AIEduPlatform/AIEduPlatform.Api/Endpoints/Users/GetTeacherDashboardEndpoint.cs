...
public class GetTeacherDashboardEndpoint : EndpointWithoutRequest<ApiResponse<TeacherDashboardStats>>
{
    ...
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            ...
            s.Response<ApiResponse<TeacherDashboardStats>>(200, "Dashboard statistics");
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await SendOkAsync(ApiResponse<TeacherDashboardStats>.Ok(result), ct);
    }
}
