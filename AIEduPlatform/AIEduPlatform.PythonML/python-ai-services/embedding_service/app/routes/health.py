...
async def readiness_check():
    ...
    try:
        ...
        test_embedding = embedding_model.encode_single("health check test")
        
        if len(test_embedding) == embedding_model.dimension:
            return {
                "status": "ready",
                "message": "Service is ready to accept requests"
            }
        else:
            raise Exception("Model output dimension mismatch")
    except Exception as e:
